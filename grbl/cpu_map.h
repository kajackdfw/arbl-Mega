...
/* The cpu_map.h files serve as a central pin mapping selection file for different 
   processor types or alternative pin layouts. This version of Arbl supports only the
   Arduino Mega2560. */
...
#define cpu_map_h
  ...
  #define DIRECTION_DDR     DDRC // analog pins
  ...
  #define LIMIT_DDR       DDRB // pins 8 to 13 see https://www.arduino.cc/en/Reference/PortManipulation
  #define LIMIT_PORT      PORTB
  #define LIMIT_PIN       PINB
  #define A_LIMIT_BIT     1 // MEGA2560 Digital Pin 7
  #define B_LIMIT_BIT     2 // MEGA2560 Digital Pin 8
  #define C_LIMIT_BIT     3 // MEGA2560 Digital Pin 9
...
// I am not using Ramps, so ignore this block
